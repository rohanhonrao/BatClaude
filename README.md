...
| **Alcove** | A perfume collection: what you've **Collected** and what you're **Coveting**, original or dupe, who it's for, and where to buy it. Records sellers with price and *your* authenticity judgement, and gathers decant sources in one place. **Research this bottle** copies a ready-made prompt and opens Claude — what it's a dupe of, a short review summary, prices and authorised retailers come back as JSON you paste straight in. Stays on your phone — not shared. |
