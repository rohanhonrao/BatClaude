...
| **Alcove** | A perfume collection on two shelves — **Collected** and **Coveted** — shown as bottles, not a list. Add one with just a name, a house and a shelf; photograph it yourself or let it show a generated monogram. Wear, original-or-dupe, notes and where to buy are meant to arrive from research. Records sellers with price and *your* authenticity judgement, and gathers decant sources in one place. **Research this bottle** copies a ready-made prompt and opens Claude — what it's a dupe of, a short review summary, prices and authorised retailers come back as JSON you paste straight in. Stays on your phone — not shared. |
